  ...
  return (
    <div className='bg-gray-800 text-white h-screen fixed left-0 top-0 bottom-0 space-y-2 w-64'>
      ...
      <div className='px-4'>
        ...
        <NavLink to="/admin-dashboard/attendance" className={({isActive}) => `${isActive ? "bg-teal-500 " : " "}flex items-center space-x-4 block py-2.5 px-4 rounded`}>
            <FaClock/>
            <span>Chấm công</span>
        </NavLink>
        ...
        <NavLink to="/admin-dashboard/reward-discipline" className={({isActive}) => `${isActive ? "bg-teal-500 " : " "}flex items-center space-x-4 block py-2.5 px-4 rounded`}>
            <FaMoneyBillWave/>
            <span>Khen thưởng</span>
        </NavLink>

        <NavLink to="/admin-dashboard/contracts" className={({isActive}) => `${isActive ? "bg-teal-500 " : " "}flex items-center space-x-4 block py-2.5 px-4 rounded`}>
            <FaFileContract/>
            <span>Hợp đồng</span>
        </NavLink>
