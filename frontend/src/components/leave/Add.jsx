...
const Add = () => {
  ...
  return (
    <div className='max-w-4xl mx-auto mt-10 bg-white p-8 rounded-md shadow-md'>
        <h2 className='text-2xl font-bold mb-6 text-black'>Yêu cầu nghỉ phép</h2>
            ...
            <div className='flex flex-col space-y-4'>
                <div>
                    ...
                    <select name = "leaveType" onChange={handleChange} className="mt-1 p-2 block w-full border border-gray-300 rounded-md" required>
                        <option value="">Lựa chọn loại nghỉ</option>
                        <option value="Sick Leave">Nghỉ ốm</option>
                        <option value="Casual Leave">Nghỉ phép thường xuyên</option>
                ...
                <div>
                    ...
                    <textarea name="reason" placeholder='Mô tả' onChange={handleChange} className="w-full border border-gray-300"/>
                </div>
            </div>
